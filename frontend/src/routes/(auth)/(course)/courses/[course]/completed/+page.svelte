	...
	<Card.Root class="mb-6 border-2 border-green-200 bg-gradient-to-br from-green-50 to-emerald-50">
		<Card.Content class="p-8">
			<div class="text-center">
				<!-- Main trophy icon -->
				<div class="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 shadow-lg">
					<Trophy class="h-10 w-10 text-white" />
				</div>

				<!-- Congratulations title -->
				<h1 class="mb-4 text-3xl font-bold text-green-800 md:text-4xl">
					¡Felicidades!
				</h1>
	...
	<Card.Root class="border-amber-200 bg-gradient-to-r from-amber-50 to-yellow-50">
		...
		<Card.Content class="text-center">
			<p class="mb-6 text-gray-600">
				Tu certificado está listo y disponible para descargar o compartir. 
				Demuestra tu nuevo conocimiento y habilidades.
			</p>
			...
			<div class="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
				<Button
					...
					class="bg-amber-600 text-white hover:bg-amber-700 flex items-center gap-2 px-6 py-3"
				>
					<Award class="h-5 w-5" />
					Ver Certificado
				...
				<Button
					...
					class="border-amber-300 text-amber-700 hover:bg-amber-100 flex items-center gap-2 px-6 py-3"
				>
