...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_imlargo_go-api-template_internal_dto.CreateAnswerRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_imlargo_go-api-template_internal_dto.UpdateAnswerRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/courses/{id}/kpis": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Course KPI metrics",
                        "schema": {
                            "$ref": "#/definitions/github_com_imlargo_go-api-template_internal_dto.CourseKPIResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_imlargo_go-api-template_internal_dto.CreateQuestionRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_imlargo_go-api-template_internal_dto.UpdateQuestionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/user-progress/complete": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Content completion data",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/user-progress/incomplete": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Content incompletion data",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/users/{userId}/courses/{courseId}/progress-percentage": {
            "get": {
        ...
        "/api/v1/users/{userId}/modules/{moduleId}/progress": {
            "get": {
        ...
        "/api/v1/users/{userId}/modules/{moduleId}/progress-percentage": {
            "get": {
    ...
    "definitions": {
        ...
        "github_com_imlargo_go-api-template_internal_dto.CreateQuestionRequest": {
            "type": "object",
            "required": [
                "evaluation_id",
                "points",
        ...
        "github_com_imlargo_go-api-template_internal_dto.UpdateAnswerRequest": {
            "type": "object",
            "properties": {
                "is_correct": {
                    "type": "boolean"
        ...
        "github_com_imlargo_go-api-template_internal_dto.UpdateQuestionRequest": {
            "type": "object",
            "properties": {
                "explanation": {
                    "type": "string"
